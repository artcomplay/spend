...
<div>
                        ...
                        <div class="col-12 modal-form" id="c-1-d-f">
                            ...
                            <div class="input-group input-group-sm mb-3">
                                <div class="input-group-prepend">
                                    <span class="input-group-text" id="inputGroup-sizing-sm">Наименование материала</span>
                                </div>
                            ...
                            <a href="" onclick="addItem(event, this, 'c-1-d');" aria-label="Close" data-dismiss="modal" style="color: red;">Добавить</a>
    ...
    <div class="modal fade cost-materials-edit" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="container">
                    <div class="row">
                        <div class="col-12 modal-form" id="c-1-d-e">

                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                            <h5 for="text" class="title-cost">Изменить материал</h5>
                            ...
                            <a href="" onclick="editElement(event, this, 'c-1-d');" aria-label="Close" data-dismiss="modal" style="color: red;">Изменить</a>
