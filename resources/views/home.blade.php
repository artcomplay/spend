                            ...
                            <div class="hide" id="c-10-d">
                                <table class="table table-sm" id="printTable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr id="p-i-d-t-m"><td scope="col" colspan="1" class="total-first-cost">Предварительный итог</td><td scope="col" colspan="5" class="total-first-cost"></td><td class="total-first-cost" colspan="1" id="total-before-price"></td></tr>
                                        ...
                                        <div class="warn-mess" onclick="closeWarn();"><div class="warn-text" id="warn-text">Поле переменной при выбранной операции не может быть пустым!!!</div></div>
                                    </tbody>
                                </table>
